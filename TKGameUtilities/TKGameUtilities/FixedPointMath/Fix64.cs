...
namespace TKGameUtilities.FixedPointMath
{
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 ToDegressFactor = (Fix64)180M / Pi;
        public static readonly Fix64 ToRadiansFactor = Pi / (Fix64)180M;
        ...
        public static Fix64 ToRadians(Fix64 degress)
        {
